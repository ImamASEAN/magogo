        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          >
            <div className="space-y-4 mb-10">
              {contactItems.map((item, i) => (
                ...
                >
                  ...
                  <div>
                    <div className="text-xs" style={{ color: 'rgba(26,58,42,0.45)', fontFamily: 'Space Mono, monospace' }}>
                      {item.label}
                    </div>
                    <div
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(26,58,42,0.06), rgba(45,122,79,0.06))',
            ...
            {state === 'sent' ? (
              ...
              <>
                ...
                <div className="space-y-4">
                  {/* Name */}
                  <div>
                    <label className="block text-xs font-medium mb-1.5" style={{ color: 'rgba(26,58,42,0.5)', fontFamily: 'Space Mono, monospace' }}>
                      YOUR NAME
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Tell us about your interest in MagoGo..."
                      rows={4}
                  ...
                  >
                    {state === 'sending' ? (
                      <>
                        <div className="w-4 h-4 rounded-full border-2 border-lime-400/40 border-t-lime-400 animate-spin" />
                        Sending...
                      </>
                    ) : (
                      <>
