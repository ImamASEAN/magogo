...
const floatingCards = [
  ...
  { icon: Weight, label: 'Biomass', value: '850g', status: '+12% today', color: '#0C6247', delay: 0.6, className: 'bottom-[10%] right-[8%] md:right-[12%]' },
]
          ...
          <div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.45 }}
              ...
              <a href="#product"
                ...
                style={{ background: 'var(--color-forest)', color: 'var(--color-lime)', fontFamily: 'Space Grotesk, sans-serif', boxShadow: '0 4px 24px rgba(5,65,42,0.25)' }}>
                Explore Technology
              ...
              <a href="#contact"
                ...
                style={{ color: 'var(--color-forest)', fontFamily: 'Space Grotesk, sans-serif', border: '1.5px solid rgba(12,98,71,0.3)' }}>
                Contact Us
              </a>
            </motion.div>
